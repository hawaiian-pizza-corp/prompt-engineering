...
4. The main slide should integrate a mermaid diagram to explain clearly the architecture of ECI
5. The last slide should include 3-5 relevant web references with:
